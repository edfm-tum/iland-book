...
In @lst-js-globalvar <!--# cross-reference doesn't work, no idea why. Same problem as in chapter "Managing simulation experiments" --> we have global variables and code, as well as functions.
...
As mentioned above, the user interface includes a simple "JavaScript code editor" that allows calling of JavaScript functions (@fig-js-editor). In addition, the user can load JavaScript source from the iLand user interface. 
