...
``` {#lst-js-write-extra-output .javascript}
...
function Logger(logfile) {
	...
	this.log = function(id, txt) { var line=Globals.year + ";" + id + ";" + txt; 
								this.text = this.text + "\n" + line; }
}
```
...
function processStand(obj) {
 // ...
 plog.log(obj.standId, `Processing started. Try to remove ${obj.proportion}.` );
 // ...
}
