...
In addition, this mechanism is used in the [fire module](https://iland-model.org/wiki/fire-module.html "technical description of the fire module in iLand") to allow some evaluation work after a fire happened.
...
-   how you can get gridded information from iLand, and can use that for simple "raster algebra" operations (see [iLand API](https://iland-model.org/apidoc/index.html))
