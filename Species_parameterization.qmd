...
Remember to check whether a tree species has already been parameterized. Initial parameter sets are already available for over 100 tree species [@thom2024], and subsequent studies may have already added new species (see the [iLand publications](https://iland-model.org/iland-publications.html) page).
