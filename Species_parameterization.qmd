...
Environmental and forest data, encompassing climate variables, soil conditions, and long-term empirical observations, are essential for effective parameter calibration (see also [iLand inputs](iLand_inputs.qmd), [Setting up landscapes](Setting_up_landscapes.qmd), and [Calibration and evaluation](Calibration_evaluation.qmd) chapters).
