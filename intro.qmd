...
-   [**Climate**](https://iland-model.org/wiki/climatedata.html): The model uses daily weather data (temperature, precipitation, sunlight, etc.) provided at the local level. This means it can simulate differences in climate within a landscape, such as mountain areas with varying weather patterns.

-   [**Light**](https://iland-model.org/wiki/competition-for-light.html)**:** A key driver of competition between trees, iLand uses a specialized approach to calculate how neighboring trees shade each other. This calculation takes into account a tree's size, shape, species, and the changing position of the sun over time.

-   [**Water**](https://iland-model.org/wiki/water-cycle.html): iLand simulates the entire water cycle on a daily basis. This includes rainfall interception by leaves, snow accumulation and melting, soil water storage, and the water used by trees. It even has the option to include specialized modeling of permafrost (permanently frozen ground) dynamics.
...
[**Growth**](https://iland-model.org/wiki/growth.html)\
...
[**Mortality**](https://iland-model.org/wiki/base-mortality.html)\
...
[**Regeneration**](https://iland-model.org/wiki/regeneration.html)\
...
-   [**Wind**](https://iland-model.org/wiki/wind-disturbance.html)\
...
-   [**Wildfire**](https://iland-model.org/wiki/wildfire.html)\
...
-   [**Spruce bark beetle**](https://iland-model.org/wiki/bark-beetle-disturbance.html)\
...
-   [**BITE framework**](https://iland-model.org/wiki/bite.html)\
...
iLand can simulate common forestry practices like planting, thinning, and harvesting trees. Using Javascript, users can precisely [define](https://iland-model.org/wiki/management.html) when and where these happen, and which types of trees are affected.

It also includes a sophisticated management module ([ABE](https://iland-model.org/wiki/abe.html)) to model complex forest management strategies. ABE simulates different managers across the landscape who make decisions based on their goals, the current state of the forest, and how it's expected to change due to things like climate or disturbances.
