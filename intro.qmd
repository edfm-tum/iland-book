...
iLand aims to balance scientific detail with a focus on being fast and useable within the limits of real-world computers. It makes design choices to improve performance, and by being open-source, developers around the world can see how it works and help improve it.

## Main entities and environmental factors modeled in iLand

![Overview over main entitites simulated in iLand.](images/iLand-model-components.png){#fig-entities}
...
## Overview on demographic processes
...
![Overview on main demographic processes modeled by iLand.](images/iland-process-overview.png){#fig-iland-processes}
...
![High-level overview on disturbance agents and forest management modules implemented in iLand.](images/iland-disturbance-overview.png){#fig-iland-disturbance-modules}
...
The browsing module is a simple representation of the effeect of browsing of ungulated on tree regeneration. The process affects growth rate of sapling and is parameterized using species specific browsing probabilities and an overall browsing pressure representing ungulate density (<https://iland-model.org/browsing>, [@holzer2024]).
...
The permafrost module of iLand simulates permafrost and soil-surface organic layer (SOL) dynamics at a fine spatial (1 ha) and temporal (daily) resolution. It efficiently models daily changes in permafrost depth, annual SOL accumulation, and their complex effects on boreal forest structure and functions [@hansen2023] (<https://iland-model.org/permafrost>).
...
iLand is a general model of forest ecosystem dynamics. It can and has be employed to tackle a wide variety of ecology- and management-related questions. Major applications of the model are:
