...
```
A generic example of running ilandc in the command-line. *years* and *additional-options* are placeholders that have to be replaced by actual values, see @lst-specific-ilandc-example.
:::
...
## Kristin's notes: Next steps for this section {#sec-iLand-windows-cluster}
