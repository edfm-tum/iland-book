...
-   **Stable releases**\
    Visit the [download page](https://iland-model.org/download.html) of iland-model.org for regular releases. Windows packages are available for direct download.
...
For more details, see the iLand Software page: <https://iland-model.org/wiki/iland-software.html>
...
-   [project file](https://iland-model.org/wiki/project-file.html)\
...
-   [species parameters](https://iland-model.org/wiki/species-parameter.html)\
    They define properties / traits of tree species. Tree species parameters are stored in a database, typically in the `database` folder. Related to species traits are also the [light influence patters](https://iland-model.org/wiki/competition-for-light.html) stored in the `lip` folder.

-   [spatial data](https://iland-model.org/wiki/landscape-setup.html)\
...
-   [climate data](https://iland-model.org/wiki/climatedata.html)\
...
-   [vegetation data](https://iland-model.org/wiki/initialize-trees.html)\
...
-   for more information see iLand wiki pages on [simulation extent](https://iland-model.org/wiki/simulation-extent.html) and subsection [grid mode](https://iland-model.org/wiki/simulation-extent.html#grid-mode)
...
-   for more information see the chapter on [landscape setup](Setting_up_landscapes.qmd) and the wiki section on [Setting up the stand grid](https://iland-model.org/wiki/landscape-setup.html#setting-up-the-stand-grid)
...
-   for more information see wiki section on [digital elevation model](https://iland-model.org/wiki/simulation-extent.html#digital-elevation-model)
-   node in project-file: *model.world.DEM*

**Wind topoModifier-grid**

-   .txt- or .asc-file, resolution of 100x100 m
-   only needed if the [wind module](https://iland-model.org/wiki/wind-module.html) is used, scales the global wind pattern to a local value, values per resource unit
...
-   for more information on the environment file see wiki page on [ClimateData](https://iland-model.org/wiki/climatedata.html)
...
-   for more information see wiki page on [species parameter](https://iland-model.org/wiki/species-parameter.html)
...
-   for more information see wiki section on [spatially distributed parameters](https://iland-model.org/wiki/simulation-extent.html#spatially-distributed-parameters)
...
-   see wiki page on [initialize trees](https://iland-model.org/wiki/initialize-trees.html) and subsection about [tree distribution input files](https://iland-model.org/wiki/initialize-trees.html#tree-distributions)
...
-   see section on [Snapshots](https://iland-model.org/wiki/initialize-trees.html#snapshots) and chapter on [spinup](https://iland-model.org/wiki/spinup.html)
...
-   see wiki page on [Lightroom](https://iland-model.org/wiki/lightroom.html "iLand wiki: light interference pattern")
