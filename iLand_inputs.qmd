...
* for more information see the chapter on  [digital elevation model](https://iland-model.org/simulation+extent?highlight=elevation#digital_elevation_model "iLand wiki: DEM"). When no DEM is given, a flat topography is assumed
...
<!--# jonas: frage: werden mit dem Buch, release von iLand 2.0, oder species data paper die standard lip.bin files mitgeliefert? -->
