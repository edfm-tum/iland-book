...
### Dependencies
::: callout-important
## Different Qt Version in *dev* and *main*

The *main* branch of iLand 2.0 was built and tested using Qt 6.5 and we strongly recommend to use this version to work with the main branch. Since iLand is under continuous development new versions of the underlying software will enter the stage from time to time. This mainly relates to the *dev* branch, in which new features are implemented and tested. As of September 2024, the *dev* branch is based on Qt 6.7 and might even be updated to Qt 6.8 in the foreseeable future. Until further notice, please use Qt 6.7 if you want to work with the development version of iLand (*dev* branch on github)
:::

Depending on your system configuration you might have to manually install additional linux libraries. If you encounter problems running iLand after building it according to the this guide, check these websites:

* **Qt 6.5**\
<https://doc-snapshots.qt.io/qt6-6.5/linux.html>\
<https://doc-snapshots.qt.io/qt6-6.5/linux-requirements.html>

* **Qt 6.7**\
<https://doc.qt.io/qt-6/linux-requirements.html>

In the *dev* branch the support for `GeoTIFF` files was added. This feature uses a library called `FreeImage`. You can find the library on the website of the developers: [FreeImage](https://freeimage.sourceforge.io/). On **Linux** necessary dependencies can be installed directly (example for Ubuntu):\
