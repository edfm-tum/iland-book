...
This is applicably mostly on large server infrastructure, for example high performance computing clusters. In such an environment you typically only want to build the [console version of iLand](https://iland-model.org/wiki/iland-console.html).
