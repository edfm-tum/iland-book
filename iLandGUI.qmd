...
![The Javascript editor tab allows interactive writing and running of JavaScript code.](images/clipboard-3240416411.png){#fig-working-javascripteditor width="61%"}
...
![The "visualization options" tab of iLand controls what and how information is displayed in the model.](images/clipboard-3404035556.png){#fig-working-visualization-options width="49%"}
...
![The function plotter is tool to test and visualize iLand expressions.](images/clipboard-3452768499.png){#fig-working-functionplotter width="67%"}
