...
<img class="zoom-when-hover" src="images/SettingsEditor_II.PNG" alt="Corresponding extract from Settings Editor to the sample extract from the project file shown in the other image" width=48%> 
<img class="zoom-when-hover" src="images/SettingsEditor_III.PNG" alt="The same extract from the Settings Editor but with the comment dialog opened." width=48%>
