...
**(2)** The main panel shows the legend, but provides also access to the scripting engine - see @sec-main-tab\
...
-   **seed availability**\
    This shows the seed availability of a selected species (4) on the 20m seed dispersal grid.
