...
-   Initialize trees in monospecific stands along this gradient and simulate stand development without allowing for interactions between stands (i.e., [torus mode enabled](https://iland-model.org/wiki/simulation-extent.html#single-resource-units-and-the-torus)).
